...
using Paradigm.Services.Mvc.Extensions;
...
namespace Paradigm.Services.Mvc.ORM.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static void UseParadimFramework(this IServiceCollection serviceCollection, Assembly assembly = null)
        {
            if (serviceCollection == null)
                throw new ArgumentNullException(nameof(serviceCollection));

            serviceCollection.UseDomain(assembly);
            serviceCollection.UseDatabaseAccess(assembly);
            serviceCollection.UseDatabaseReaderMappers(assembly);
            serviceCollection.UseStoredProcedures(assembly);
            serviceCollection.UseRepositories(assembly);
            serviceCollection.UseProviders(assembly);
            serviceCollection.UseWorkingTasks(assembly);
        ...
        /// <param name="serviceCollection">The service collection.</param>
        /// <param name="assembly">Optional assembly to use as entry point.</param>
        public static void UseDatabaseAccess(this IServiceCollection serviceCollection, Assembly assembly = null)
        {
            if (serviceCollection == null)
                throw new ArgumentNullException(nameof(serviceCollection));
        ...
        /// <param name="serviceCollection">The service collection.</param>
        /// <param name="assembly">Optional assembly to use as entry point.</param>
        public static void UseDatabaseReaderMappers(this IServiceCollection serviceCollection, Assembly assembly = null)
        {
            if (serviceCollection == null)
                throw new ArgumentNullException(nameof(serviceCollection));
        ...
        /// <param name="serviceCollection">The service collection.</param>
        /// <param name="assembly">Optional assembly to use as entry point.</param>
        public static void UseStoredProcedures(this IServiceCollection serviceCollection, Assembly assembly = null)
        {
            if (serviceCollection == null)
                throw new ArgumentNullException(nameof(serviceCollection));
