...
using Paradigm.Services.Mvc.ORM.Extensions;
using Paradigm.Services.Repositories.UOW;
using Paradigm.Services.Tests.Fixtures.Tests.Extensions.MVC;

namespace Paradigm.Services.Tests.Tests.Extensions.MVC
{
    [TestFixture]
    ...
    {        
        ...
        public void ShouldRegisterObjects()
        {
            ...
            serviceCollection.UseDomain(entryPoint);
            serviceCollection.UseDatabaseAccess(entryPoint);
            serviceCollection.UseDatabaseReaderMappers(entryPoint);
            serviceCollection.UseStoredProcedures(entryPoint);
            serviceCollection.UseRepositories(entryPoint);
            serviceCollection.UseProviders(entryPoint);        
            serviceCollection.UseWorkingTasks(entryPoint);
        ...
        public void ShouldResolveObjectsWithParadigmFramework()
        {
            ...
            serviceCollection.AddScoped<IDatabaseConnector, MySqlDatabaseConnector>();
            serviceCollection.UseParadimFramework(entryPoint);
